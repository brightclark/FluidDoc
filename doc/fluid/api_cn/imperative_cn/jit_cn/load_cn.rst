...
将接口 :ref:`cn_api_imperative_jit_save` 或者 :ref:`cn_api_fluid_io_save_inference_model` 存储的模型载入为 :ref:`cn_api_imperative_TranslatedLayer` ，用于预测推理或者fine-tune训练。
...
1. 载入由接口 :ref:`cn_api_imperative_jit_save` 存储的模型进行预测推理及fine-tune训练。
